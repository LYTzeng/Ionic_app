...
exports.sheetToFirestoreStudent = functions.https.onRequest((req, res) => __awaiter(this, void 0, void 0, function* () {
    console.log(JSON.stringify(req.body, null, 4));
    const studentId = req.body.studentId;
    const student = req.body.student;
    yield studentCollection.doc(studentId).update(Object.assign({}, student))
        .catch(() => studentCollection.doc(studentId).set(Object.assign({}, student)));
    res.sendStatus(200);
}));
exports.sheetToFirestoreMember = functions.https.onRequest((req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield studentCollection.doc(studentId).update({ member })
...
exports.sheetToFirestorePerformance = functions.https.onRequest((req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield studentCollection.doc(studentId).update({ performance })
