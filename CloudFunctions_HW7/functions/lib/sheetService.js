...
exports.authorize = () => {
    return new Promise(resolve => {
        const secret = sheetConfig_1.sheetSecret.installed.client_secret;
        const clientId = sheetConfig_1.sheetSecret.installed.client_id;
        const redirectUrl = sheetConfig_1.sheetSecret.installed.redirect_uris[0];
        const oauth2Client = new google_auth_library_1.OAuth2Client(clientId, secret, redirectUrl);
        oauth2Client.setCredentials({
            access_token: sheetConfig_1.sheetToken.access_token,
            refresh_token: sheetConfig_1.sheetToken.refresh_token
        });
