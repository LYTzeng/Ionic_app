...
import { sheetSecret, sheetToken } from "./sheetConfig"

export const authorize = (): Promise<OAuth2Client> => {
    return new Promise(resolve => {
        const secret = sheetSecret.installed.client_secret
        const clientId = sheetSecret.installed.client_id
        const redirectUrl = sheetSecret.installed.redirect_uris[0]
